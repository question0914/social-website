    ...
    $uploadFileButton.on('click', function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                console.log(res);
                document.getElementById('prof-img').src=res;
            },
...
document.getElementById('changePhoto').addEventListener("click", uploadphoto);//function(){ alert("Hello World!"); }
if(document.getElementById('changeCover'))
document.getElementById('changeCover').addEventListener("click", uploadphoto);//function(){ alert("Hello World!"); }

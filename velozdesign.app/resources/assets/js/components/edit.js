    ...
    if(!this.props.canEdit)
    {
      return (
        <span className="myedit">
          <a href="#" className={this.props.classnm} /*className="profile-full-name" href="#" onMouseOver={this.handleMouseOver} onMouseOut={this.handleMouseOut}*/>
          {this.state.text}&nbsp;&nbsp;
          </a>
        </span>
      )
...
// ReactDOM.render(<ChangePhoto imgSrc="old img src" />,document.getElementById('parent'));
